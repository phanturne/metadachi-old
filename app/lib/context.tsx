// Source: https://github.com/mckaywrigley/chatbot-ui/blob/main/context/context.tsx
...
import { AssistantImage } from "@/app/lib/types/images/assistant-image"
import { Dispatch, SetStateAction, createContext } from "react"
import { VALID_ENV_KEYS } from "@/app/lib/types/valid-keys"

interface MetadachiContext {
  // PROFILE STORE
...
export const MetadachiContext = createContext<MetadachiContext>({
  // PROFILE STORE
  profile: null,
  setProfile: () => {},
